const tabProject = [
  ...
  }, 
  {
    ...
    image: "./assets/healven.png",
    typeProject: "app",
  }, 
  {
    title: "RuckField",
    description: "Réalisation de l'interface d'un site de vente de produits en rapport avec le rugby. J'ai utilisé mes compétences en HTML/CSS pour développer un site web plutôt simple mais qui a été très enrichissant pour moi en termes de compétences techniques.",
    image: "./assets/ruckfield.png",
    typeProject: "site",
  },
  {
    title: "FoodYril",
    description: "Ce projet, qui s'est déroulé sur un an, a été ma première réalisation avec React Native. L'application a pour but de simplifier la recherche de recettes et de guider de A à Z l'utilisateur pendant la préparation de celles-ci. En ce qui concerne le Back-End, j'ai relié l'application à l'outil Firestore de Google et j'ai ensuite optimisé les fonctions de requête. Ce projet m'a permis de développer mes compétences en développement mobile et en gestion de projet.",
    image: "./assets/foodyril.png",
    typeProject: "app",
  }, 
]
